...
This is the single canonical specification location for PSSP. The bootstrap request names this concept but does not supply its mathematics or complete design. No additional definitions, equations, dimensions, behavior or implementation are inferred here.
